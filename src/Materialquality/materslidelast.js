...
export  default class MaterlialLast extends Component {
  _isMounted = false;
  ...
  static navigationOptions = ({ navigation }) => ({
    ...
    storage.sync = {
      ...
      async safety(params) {
        return (
          fetch("http://phlapp.drcmp.org/api/getmaterialshouseimagess", {
            method: "GET",
            headers: {
    ...
    return (
      <Container>
        ...
        {this.state.safetyData == null ? (
          ...
          >
            <Text style={styles.customBtnText}>Material quality and storage </Text>
          </Button>
          <Button
            style={styles.customBtnBG}
                ...
                return (
                  <Card style={[styles.card, styles.card1]}>
                    <View >
                      ...
                      <View style={{borderBottomWidth:2,height:250}}>
